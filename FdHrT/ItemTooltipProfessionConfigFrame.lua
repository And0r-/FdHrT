...
local function CreateEditBox( name, x, y, label, tooltip )
...
local function CreateNeedList()

	CreateEditBox( "ItemTooltipIconsConfigCheck1e8", 100, -100, " Tailoring", nil )
...
dialogHeader:SetText( "Wer will was:" )
